...
\newcommand{\jaculatorias}[0]{
  ...
  \node at (1,\the\ypos) {Glória ao Pai, ao Filho e ao Espírito Santo, como era no princípio, agora e sempre, Amém!\\ Finaliza-se com as \textbf{\nameref{oracoes-jaculatorias}} prediletas.} ;
}
